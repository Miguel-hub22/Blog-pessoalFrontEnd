...
function CadastroPost() {
    ...
    const [tema, setTema] = useState<Tema>( // tema expecífico 
        {
            id: 0,
            descricao: ''
        })
    ...
    async function onSubmit(e: ChangeEvent<HTMLFormElement>) { // enviar todos os dados da postagens
        e.preventDefault()
